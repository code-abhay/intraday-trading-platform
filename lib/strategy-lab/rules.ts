...
export const STRATEGY_LAB_RULES: StrategyRuleSpec[] = [
  ...
  {
    id: "kumo_volumetric_breakout",
    name: "Kumo Volumetric Breakout",
    qualityRating: "A",
    marketEnvironment: "Trend initiation and accumulation release",
    indicators: ["Ichimoku Cloud", "OBV", "MFI", "Volume structure", "ATR"],
    multiTimeframeAlignment:
      "60m structure establishes bias while 5m Kumo breakout confirms directional release.",
    longEntryRules: [
      "Price consolidates near or below Kumo and closes above cloud edge.",
      "OBV makes a fresh local high ahead of/with breakout.",
      "MFI stays above institutional participation threshold.",
      "Breakout clears HVN and moves into low-volume vacuum.",
    ],
    shortEntryRules: [
      "Price consolidates near or above Kumo and closes below cloud edge.",
      "OBV makes a fresh local low ahead of/with breakdown.",
      "MFI stays below bearish flow threshold.",
      "Breakdown clears HVN and moves into low-volume vacuum.",
    ],
    optionsSelection: [
      "Prefer ATM or slight ITM for stable delta during confirmation.",
      "Current weekly for Monday-Wednesday; shift to next weekly late-week if needed.",
    ],
    riskModel: [
      "Stop 1.5 ATR beyond the opposite Kumo edge.",
      "Per-trade risk 0.5% with 2.0% daily cap.",
    ],
    tradeManagement: [
      "Book partial into first structure extension.",
      "Trail remainder using Kijun/EMA21 proxy.",
    ],
    invalidationRules: [
      "Price returns inside Kumo within three bars.",
      "MFI participation fails during breakout follow-through.",
    ],
    engine: {
      executionIntervalMin: 5,
      higherIntervalsMin: [60],
      ...
      params: {
        ...
        obvBreakLookback: 12,
        vacuumMin: 0.35,
        breakoutVolumeMult: 1.2,
      },
    },
  },
  {
    id: "ib_volatility_expansion",
    name: "IB Volatility Expansion",
    qualityRating: "A",
    marketEnvironment: "Opening drive and morning volatility expansion",
    indicators: ["Initial Balance", "VWAP", "Supertrend", "Aroon", "ATR"],
    multiTimeframeAlignment:
      "15m gap/overnight context sets bias, 3m breaks initial balance with momentum alignment.",
    longEntryRules: [
      "Price closes above first-45-minute initial balance high.",
      "Aroon Up spikes above 80 and dominates Aroon Down.",
      "Price holds above rising VWAP with fresh Supertrend support.",
    ],
    shortEntryRules: [
      "Price closes below first-45-minute initial balance low.",
      "Aroon Down spikes above 80 and dominates Aroon Up.",
      "Price holds below falling VWAP with fresh Supertrend resistance.",
    ],
    optionsSelection: [
      "Prefer ATM for morning gamma expansion and clean fills.",
      "Current weekly expiry for pure intraday opening-drive execution.",
    ],
    riskModel: [
      "Stop around VWAP with ATR buffer.",
      "Per-trade risk 0.45% with 1.4% daily cap.",
    ],
    tradeManagement: [
      "Scale early at first impulse extension.",
      "Trail remainder with supertrend direction.",
    ],
    invalidationRules: [
      "Contrary Aroon spike indicates two-way distribution.",
      "Breakout fails and falls back into initial balance.",
    ],
    engine: {
      executionIntervalMin: 3,
      higherIntervalsMin: [15],
      ...
      params: {
        ...
        aroonSpikeMin: 80,
        aroonConflictMax: 50,
        atrExpansionMin: 1.08,
        ibBreakVolumeMult: 1.15,
        supertrendFactor: 3,
        supertrendAtrPeriod: 10,
      },
    },
  ...
  {
    id: "pcr_capitulation_reversal",
    name: "PCR Capitulation Reversal",
    qualityRating: "A",
    marketEnvironment: "Sentiment capitulation and mean-reversion squeeze",
    indicators: ["PCR", "OI buildup", "Bollinger Bands", "MFI", "ATR"],
    multiTimeframeAlignment:
      "60m context tracks panic extremes; 5m trigger confirms reclaim from capitulation tails.",
    longEntryRules: [
      "PCR drops to capitulation territory for the segment.",
      "Price pierces lower Bollinger band then re-enters band on reversal close.",
      "MFI forms bullish recovery from oversold zone.",
      "OI pressure starts stabilizing versus prior downside impulse.",
    ],
    shortEntryRules: [
      "PCR spikes to euphoria territory for the segment.",
      "Price pierces upper Bollinger band then re-enters band on reversal close.",
      "MFI forms bearish recovery from overbought zone.",
      "OI pressure starts stabilizing versus prior upside impulse.",
    ],
    optionsSelection: [
      "Prefer ATM or one-strike OTM for fast squeeze response.",
      "Current weekly expiry for intraday mean-reversion bursts.",
    ],
    riskModel: [
      "Structural stop beyond capitulation wick plus ATR pad.",
      "Per-trade risk 0.4% with 1.5% daily cap.",
    ],
    tradeManagement: [
      "Scale at Bollinger midline test.",
      "Trail remaining position toward opposite band / EMA21.",
    ],
    invalidationRules: [
      "PCR remains one-way extreme while price extends trend.",
      "MFI recovery fails immediately after trigger.",
    ],
    engine: {
      executionIntervalMin: 5,
      higherIntervalsMin: [60],
      ...
      dailyRiskCapPct: 1.5,
      params: {
        pcrCapitulationLow: 0.62,
        pcrCapitulationHigh: 1.48,
        mfiOversold: 20,
        mfiOverbought: 80,
        mfiRecovery: 3,
        divergenceLookback: 18,
  ...
  {
    id: "channel_adx_oi_breakout",
    name: "Channel-ADX OI Breakout",
    qualityRating: "A",
    marketEnvironment: "Trend expansion with options flow confirmation",
    indicators: ["Channel Breakout", "ADX", "OI buildup", "VWAP", "ATR"],
    multiTimeframeAlignment:
      "60m trend context aligns with 5m channel breakout and OI participation shift.",
    longEntryRules: [
      "Price closes above rolling channel high.",
      "ADX rises through trend-strength threshold.",
      "OI short buildup dominates at/after breakout.",
      "Price holds above VWAP after trigger.",
    ],
    shortEntryRules: [
      "Price closes below rolling channel low.",
      "ADX rises through trend-strength threshold.",
      "OI long buildup dominates at/after breakdown.",
      "Price holds below VWAP after trigger.",
    ],
    optionsSelection: [
      "Prefer ATM/1-strike OTM for directional expansion.",
      "Use weekly expiry, and shift to next weekly when trend appears late.",
    ],
    riskModel: [
      "Stop near channel midpoint with ATR extension.",
      "Per-trade risk 0.55% with 2.0% daily cap.",
    ],
    tradeManagement: [
      "Book partial at first extension.",
      "Trail remainder with EMA9/Supertrend proxy.",
    ],
    invalidationRules: [
      "ADX stalls immediately after breakout.",
      "OI confirmation flips within two bars.",
    ],
    engine: {
      executionIntervalMin: 5,
      higherIntervalsMin: [60],
      ...
      maxBarsInTrade: 28,
      minBarsBetweenTrades: 4,
      riskPerTradePct: 0.55,
      dailyRiskCapPct: 2,
      params: {
        channelLookbackBars: 9,
        minAdx: 28,
        oiSkewMin: 0.05,
        breakoutVolumeMult: 1.1,
      },
    },
  },
];
